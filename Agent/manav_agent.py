...
class BlindDog(Agent):
    ...
    def cries(self, thing):
        print("Dog: Cries at {}.".format( self.location))
...
class Park(Environment):
    ...
    def execute_action(self, agent, action):
        ...
        # Question - 4
            ...
            items = self.list_things_at(agent.location, tclass=Firecracker)
            if len(items) != 0:
                if agent.cries(items[0]):  # Let the dog cry
                    print('{} cries at location: {}'
...
class BlindDog(Agent):
    ...
    def cries(self, thing):
        ''' returns True upon success or False otherwise'''
        if isinstance(thing, Firecracker):
            return True
        return False
    ##########
...
# Question - 3
manav = Firecracker()
chaudhary = Firecracker()

park.add_thing(dog, 1)
park.add_thing(dogfood, 5)
park.add_thing(manav, 6)
park.add_thing(chaudhary, 9)

# Question - 1
park.add_thing(water, 12)
